...
//                            <elementParameter field="TEXT" name="ESB_ENDPOINT" value="&quot;http://localhost:8200/esb/AirportService&quot;"/>
        ...
        File tempFile = new File(getContext().getProductionPath()+"\\dependencies.dot");
        FileWriter writer = new FileWriter(tempFile);
        IOUtils.write(sb.toString(), writer);
        writer.flush();
        DotHelper.generatePNG(getContext().getDotPath(), getContext().getProductionPath() + "\\dependencies.png", tempFile);
